...
| Same-publisher in-band Fence marker (`meta/fence/**`, `sitos.v1.fence`) | Planned | Planned | [ADR-0029](adr/0029-define-same-publisher-fence-ordering.md) *(Proposed)* | ADR-0029 | #158; consumers #99, #107 |
| `FenceLaneAttachmentV1` (25-byte Publisher UUIDv4 and sequence ordering metadata) | Planned | Planned | [ADR-0029](adr/0029-define-same-publisher-fence-ordering.md) *(Proposed)* | ADR-0029 | #158; consumers #99, #107 |
